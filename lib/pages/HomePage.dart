...
import 'package:msport/pages/BookingPage.dart';
          ...
          children: [
            ...
            Expanded(
              child: IndexedStack(
                ...
                children: [
                  buildNewsPage(), // index 0
                  BookingPage(), // index 1
                  Center(child: Text("Trang Trang chủ")), // index 2
                  Center(child: Text("Trang Ghi chú")), // index 3
                  Center(child: Text("Trang Cá nhân")), // index 4
                ],
              ),
            ),
            SizedBox(height: 20),
